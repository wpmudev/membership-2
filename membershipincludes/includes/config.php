...
// normal or adv
if(!defined('MEMBERSHIP_DEBUG_LEVEL')) define( 'MEMBERSHIP_DEBUG_LEVEL', 'normal');
...
if(!defined('MEMBERSHIP_EXCLUDE_HOMEPAGE_FROM_PROTECTION')) define('MEMBERSHIP_EXCLUDE_HOMEPAGE_FROM_PROTECTION', false);
