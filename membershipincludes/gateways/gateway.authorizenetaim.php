<?php
/*
Addon Name: Authorize.net AIM gateway (Deprecated)
Description: The Payment gateway for Authorize.net AIM. This gateway is deprecated. Use Authorize.net gateway instead.
Author: Incsub
