...
class paypalexpress extends Membership_Gateway {
	...
	function single_sub_button($pricing, $subscription, $user_id, $norepeat = false) {
		...
		// the period unit for the sub (e.g. month, days, etc)
	...
	function complex_sub_button($pricing, $subscription, $user_id) {
		...
		// a custom field - contains data like user_id, sub_id, etc
		$form .= '<input type="hidden" name="custom" value="' . $this->build_custom($user_id, $subscription->id, number_format($ff['a3'], 2)) . '">';
