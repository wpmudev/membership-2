...
if (!class_exists('M_Member_Search')) {
    ...
    class M_Member_Search extends WP_User_Query {
        ...
        function __construct($search_term = '', $page_num = '', $sub_id = false, $level_id = false, $active = false) {
        ...
        function M_Member_Search($search_term = '', $page_num = '', $sub_id = false, $level_id = false, $active = false) {
            $this->__construct($search_term, $page_num, $sub_id, $level_id, $active);
        }
