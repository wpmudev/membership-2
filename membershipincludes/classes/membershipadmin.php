					...
					<div style="width: 98%;" class="postbox-container">
						<div class="meta-box-sortables ui-sortable" id="full-sortables">
							...
							<div class="postbox " id="dashboard_right_now">
								<h3 class="hndle"><span><?php _e('Welcome to Membership','membership'); ?></span><a href='' id='wizarddismisslink' title='<?php _e('Click here to hide the Welcome wizard.','membership'); ?>'><?php _e('Hide','membership'); ?></a></h3>
								<div class="inside">
									Hello
									<br class="clear">
								</div>
		...
		function handle_options_panel() {
			...
			<div class='wrap nosubsub'>
				<?php
					...
					$menus['pages'] = __('Pages', 'membership');
					$menus['shortcodes'] = __('Shortcodes', 'membership');
					$menus['downloads'] = __('Downloads', 'membership');
				...
				<h3 class="nav-tab-wrapper">
					<?php
						foreach($menus as $key => $menu) {
							//<a class="nav-tab nav-tab-active" href="http://dev.site/wp-admin/edit.php?post_type=product&amp;page=marketpress">General</a>
							?>
							<a class="nav-tab" href="admin.php?page=<?php echo $page; ?>&amp;tab=<?php echo $key; ?>"><?php echo $menu; ?></a>
							<?php
						}
