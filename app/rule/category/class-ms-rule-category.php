...
class MS_Rule_Category extends MS_Controller {
	...
	public function prepare_obj() {
		if ( MS_Rule_Category_Model::is_active() ) {
			MS_Model_Rule::register_rule(
				self::RULE_ID,
				__CLASS__,
				__( 'Categories', 'membership2' ),
				20,
				true
			);
		}
	...
	public function handle_render_callback( $callback, $data ) {
		$view = MS_Factory::load( 'MS_Rule_Category_View' );
	...
	public function return_listtable( $empty ) {
		...
		return new MS_Rule_Category_ListTable( $rule );
	}
