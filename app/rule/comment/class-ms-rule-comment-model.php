 ...
 * @subpackage Model
 */
class MS_Rule_Comment_Model extends MS_Model_Rule {
	...
	public function has_access( $id = null ) {
		return apply_filters(
			'ms_rule_comment_model_has_access',
			null,
			$id,
			$this
		);
	...
	public function get_rule_value( $id ) {
		...
		return apply_filters(
			'ms_rule_comment_model_get_rule_value',
			$value,
			$id,
			$this
		);
	...
	public function check_special_page( $content ) {
		...
		return apply_filters(
			'ms_rule_comment_model_check_special_page',
			$content,
			$this
		);
	}
	...
	public function count_rules( $has_access_only = true ) {
		...
		return apply_filters(
			'ms_rule_comment_model_count_rules',
			$count,
			$this
		);
	}
	...
	public function get_contents( $args = null ) {
		...
		return apply_filters(
			'ms_rule_comment_model_get_content',
			$contents,
			$args,
			$this
		);
	...
	public function get_content_array( $args = null ) {
		...
		return apply_filters(
			'ms_rule_comment_model_get_content_array',
			$contents,
			$this
		);
	}
