...
class MS_Rule_Shortcode extends MS_Controller {
	...
	public function prepare_obj() {
		if ( MS_Rule_Shortcode_Model::is_active() ) {
	...
	public function handle_render_callback( $callback, $data ) {
		$view = MS_Factory::load( 'MS_Rule_Shortcode_View' );
	...
	public function return_listtable( $empty ) {
		...
		return new MS_Rule_Shortcode_ListTable( $rule );
	}
