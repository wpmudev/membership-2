...
class MS_Model_Rule_More extends MS_Model_Rule {
	...
	public function show_moretag_protection( $more_tag_link, $more_tag ) {
		...
		return apply_filters(
			'ms_model_rule_more_show_moretag_protection',
			$msg,
			$more_tag_link,
			$more_tag,
			$this
	...
	public function replace_more_tag_content( $the_content ) {
		...
		return apply_filters(
			'ms_model_rule_more_replace_more_tag_content',
			$the_content,
			$this
		);
	}
	...
	public function get_contents( $args = null ) {
		...
		return apply_filters(
			'ms_model_rule_more_get_content',
			$contents,
			$this
		);
	}
	...
	public function get_options_array( $args = null ) {
		...
		return apply_filters(
			'ms_model_rule_more_get_content_array',
			$contents,
			$this
		);
	}
