...
class MS_Model_Rule_Buddypress extends MS_Model_Rule {
	...
	public function get_contents( $args = null ) {
		$contents = array();
		$contents[MS_Integration_BuddyPress::RULE_TYPE_BUDDYPRESS_FRIENDSHIP] = (object) array(
		...
		$contents[MS_Integration_BuddyPress::RULE_TYPE_BUDDYPRESS_GROUP_CREATION] = (object) array(
		...
		$contents[MS_Integration_BuddyPress::RULE_TYPE_BUDDYPRESS_PRIVATE_MSG] = (object) array(
