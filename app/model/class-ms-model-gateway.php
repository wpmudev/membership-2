...
class MS_Model_Gateway extends MS_Model_Option {
	...
	public function handle_return() {
		do_action(
			'ms_model_gateway_handle_return',
			$ms_relationship,
			$this
		);
	}
	...
	public function process_purchase( $ms_relationship ) {
		do_action(
			'ms_model_gateway_process_purchase_before',
			$ms_relationship,
			$this
		);
		...
		return apply_filters(
			'ms_model_gateway_process_purchase',
			$invoice
		);
	}
	...
	public function cancel_membership( $ms_relationship ) {
		do_action(
			'ms_model_gateway_cancel_membership',
			$ms_relationship,
			$this
		);
	}
	...
	public function request_payment( $ms_relationship ) {
		do_action(
			'ms_model_gateway_request_payment',
			$ms_relationship,
			$this
		);
	}
	...
	public function check_card_expiration( $ms_relationship ) {
		...
		do_action(
			'ms_model_gateway_check_card_expiration_after',
			$this
		);
	}
	...
	public function process_transaction( $invoice ) {
		do_action(
			'ms_model_gateway_process_transaction_before',
			$this
		);
	...
	public function get_return_url() {
		...
		return apply_filters(
			'ms_model_gateway_get_return_url',
			$return_url,
			$this
		);
	}
	...
	public function get_mode_types() {
		...
		return apply_filters(
			'ms_model_gateway_get_mode_types',
			$mode_types,
			$this
		);
	}
	...
	public function get_country_codes() {
		...
		if ( is_null( $Countries ) ) {
			...
			$Countries = apply_filters(
				'ms_model_gateway_get_country_codes',
				$Countries
			);
		}
