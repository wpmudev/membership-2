...
class MS_Model_Custom_Post_Type extends MS_Model {
	...
	public function check_object_lock() {
		...
		return apply_filters( 'ms_model_custom_post_type_check_object_lock', $locked, $this );
	}
	...
	public function set_object_lock() {
		...
		return apply_filters( 'ms_model_custom_post_type_set_object_lock', $lock, $this );
	}
	...
	public function is_valid() {
		...
		return apply_filters( 'ms_model_custom_post_type_is_valid', $valid, $this );
	}
}