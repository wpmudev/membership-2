...
class MS_Model_Communication_Before_Finishes extends MS_Model_Communication {
	...
	public function get_description() {
		return __( 'Sent a predefined number of days before the membership finishes. You must decide how many days beforehand a message is to be sent.', MS_TEXT_DOMAIN );
	}
