...
class MS_View_Shortcode_Membership_Signup extends MS_View {
						...
						foreach ( $this->data['ms_relationships'] as $membership_id => $ms_relationship ){
							...
							switch ( $ms_relationship->status ) {
								case MS_Model_Membership_Relationship::STATUS_CANCELED:
									$this->membership_box_html( $membership, MS_Helper_Membership::MEMBERSHIP_ACTION_RENEW, $msg, $ms_relationship, $settings );
									break;
								...
								case MS_Model_Membership_Relationship::STATUS_ACTIVE:
									$this->membership_box_html( $membership, MS_Helper_Membership::MEMBERSHIP_ACTION_CANCEL, $msg, $ms_relationship, $settings );
									break;

								case MS_Model_Membership_Relationship::STATUS_PENDING:
									$this->membership_box_html( $membership, MS_Helper_Membership::MEMBERSHIP_ACTION_SIGNUP, $msg, $ms_relationship, $settings );
									break;
				...
				<div class="ms-form-price-boxes">
					...
					<?php
						...
						foreach ( $this->data['memberships'] as $membership ) {
							$this->membership_box_html( $membership, $action, null, null, $settings );
						}
					?>
	...
	private function membership_box_html( $membership, $action, $msg = null, $ms_relationship = null, $settings = null ) {
