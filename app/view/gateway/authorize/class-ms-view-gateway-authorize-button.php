...
class MS_View_Gateway_Authorize_Button extends MS_View {
	...
	public function to_html() {
		...
		// Force ssl url
		$action_url = $pages->get_ms_page_url( MS_Model_Pages::MS_PAGE_REGISTER, true );
		$action_url = apply_filters(
			'ms_view_gateway_authorize_button_form_action_url',
			$action_url
		);
	...
	private function prepare_fields() {
		...
		return apply_filters(
			'ms_view_gateway_authorize_button_prepare_fields',
			$fields
		);
	}
}