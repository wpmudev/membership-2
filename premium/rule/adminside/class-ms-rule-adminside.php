...
class MS_Rule_Adminside extends MS_Controller {
	...
	public function handle_render_callback( $callback, $data ) {
		$view = MS_Factory::load( 'MS_Rule_Adminside_View' );
	...
	public function return_listtable( $empty ) {
		...
		return new MS_Rule_Adminside_ListTable( $rule );
	}
